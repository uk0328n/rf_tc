class AdminsController < ApplicationController
  ...
  def destroy
    @admin.destroy
    respond_to do |format|
      format.html { redirect_to admins_url, notice: 'データが削除されました。' }
  ...
  private
    ...
    def admin_params
      params.require(:admin).permit(Admin.column_names.map{|c| c.to_sym} - ['id', 'created_at', 'updated_at'], :password, :password_confirmation)
    end
end
